...
void Task_43() //Находит точку пересений двух прямых
{
    string[,] variables = {
...
void Task_optional(int min = -9, int max = 9) //Сумма элементов, находящихся на главной диагонали двумерного массива 
{
